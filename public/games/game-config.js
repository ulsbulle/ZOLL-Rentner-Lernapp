...
export const GameConfig = {
	...
	GROUND_Y: H - 20 * S,
	MARGIN: 15 * S,
	START_BUTTON: { x: W / 2 - 60 * S, y: H - 90 * S, w: 120 * S, h: 40 * S },
	...
	COLORS: {
		...
		bubble: {
			...
			bubbleFrame: "rgba(37, 99, 235, 0.1)",
	...
	PHYSICS: {
		bubble: {
			...
			targetSpeed: { base: 1.5 * S, r: 0.3, p: 0.3, d: 0.4 },
		},
		fruit: {
	...
	// Sounds
	SOUNDS: {
		bubble: { music: "bubble", bubbleBurst: "point", bubbleImplosion: "wrong" },
		fruit: {
			music: "fruit",
			vegetableCaught: "point",
			fruitCaught: "point",
			junkfoodMissed: "point",
			freshMissed: "wrong",
			junkfoodCaught: "wrong2",
		},
		horse: { music: "horse", obstacleCleared: "point", obstacleHit: "wrong", jump: "jump" },
		ufo: { music: "ufo", asteroidDestroyed: "explosion", asteroidHit: "wrong", laser: "laser", noAmmo: "empty" },
	},
	...
	INSTRUCTIONS: {
		...
		fruit: [
			...
			"Steuerung: Maus bewegen oder A / D /⬅️➡️",
		],
		horse: [
			"Reite durch den Parcours!",
			"Weiche den Straßensperren aus.",
			"Steuerung: LEERTASTE / W / ARROW_UP/⬆️",
